...
**Notes:**
- [TdlQ's Sentry Health Display](http://pd2mods.z77.fr/sentry_health_display.html) has a broken ammo counter, for some reason. This could probably do with some investigation and a fix (if it's an issue with VTC, otherwise it's out of my hands) but for now it's something to keep in mind.
